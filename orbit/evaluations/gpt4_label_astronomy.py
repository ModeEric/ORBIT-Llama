...
def construct_prompt(text):
    ...
    """
    prompt = f"""Please evaluate the educational value of the following astronomy-related text from a web document. Use this 6-point scoring system:

0 points: No astronomy content at all.
1 point: Minimal astronomy information, or astronomy mixed with non-astronomical content.
2 points: Covers basic astronomical concepts but lacks depth or comprehensive explanation.
3 points: Clear explanation of concepts with relevant examples, educational for a general audience.
4 points: In-depth knowledge, covers advanced concepts or recent discoveries, well-structured and engaging.
5 points: Exceptionally high educational value, expert-level insights, connects multiple concepts, addresses misconceptions, inspires further learning.
